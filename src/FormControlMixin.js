...
(function (global, validate) {
    ...
    function validateControl(tag) {
        ...
        console.log("Errors are", tag.errors);
    }
    ...
    var FormControlMixin = {
        ...
        validateCustom: function (errors) {
            console.debug("FormControlMixin.validateCustom(%o)", errors);
            // noop
        },

        reset: function () {
            console.debug("FormControlMixin.reset()");
            this.errors = {};
            this.valid = true;
            this.dirty = false;
            this.touched = false;
    ...
    window.FormControlMixin = FormControlMixin;
